	...
	while (fgetws(szip, sizeof(szip), fpIp))
	{
		...
		while (fgetws(szUserName, sizeof(szUserName), fpUserName))
		{
			...
			while (fgetws(szPassWord, sizeof(szPassWord), fpPassWord))
			{
				...
				cmd = GetCommandLineW();
				//cmd = L"wfreerdp.exe /u:administrator /p:lufei@123 /v:192.168.62.131:3389";
				//cmd = L"wfreerdp.exe /v:192.168.62.131:3389 /u:administrator /p:lufei@123";
